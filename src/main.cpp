...
// TODO: this seems to be using a linear function to get the XY coords near the waypoint path.
// 				Consider creating a new, more accurate, non-linear function to get the xy points. (maybe spline?)
vector<double>
...
//                cout << "I should keep lane: " << back_gap << ", " << gap_s << ", " << gap_left << ", " << gap_right << endl;
              ...
              // reference x, y and yaw state values
              double ref_x = car_x;
              double ref_y = car_y;
              ...
              if (prev_size < 2) {
                // use two points that make up the path tangent to the car
...
//              double d3 = min(4, d_diff);
              ...
              for (int i = 0; i < ptsx.size(); i++) {
                // shift car reference angle to 0 degrees--just to make future math easier
...
//              cout << ptsx[0] << ", " << ptsx[1] << ", " << ptsx[2] << ", " << ptsx[3] << ", " << ptsx[4] << ", " << endl;
//              cout << ptsy[0] << ", " << ptsy[1] << ", " << ptsy[2] << ", " << ptsy[3] << ", " << ptsy[4] << ", " << endl;

              tk::spline s;
              // When you call `set_points` to setup the spline, the first array must be in strictly increasing order
              // (so that the resulting spline can be a function).  This might cause issues if ref_vel = 0
              s.set_points(ptsx, ptsy);

              // start with all of the previous path points from last time
              // previous_path_x and y are the paths that the simulator has not executed yet
              ...
              // fill up the rest of our path planner after filling it with previous points--we'll always output 50 points
